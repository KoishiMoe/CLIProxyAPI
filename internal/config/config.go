...
type RemoteManagement struct {
	...
	// DisableControlPanel skips serving the local management UI when true.
	DisableControlPanel bool `yaml:"disable-control-panel"`
	// DisableAutoUpdatePanel is kept for compatibility with older configs.
	// Automatic management panel downloads and updates are disabled.
	DisableAutoUpdatePanel bool `yaml:"disable-auto-update-panel"`
	// PanelGitHubRepository is kept for compatibility with older configs.
	// Automatic management panel downloads and updates are disabled.
